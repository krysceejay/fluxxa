...
import { Text, View, SafeAreaView, TextInput, TouchableOpacity, Image, FlatList, Modal } from 'react-native'
...
const Clients = () => {
    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            listHeaderHeight={80}
            indexLetterStyle={{ color: '#000000', fontSize: 12, }}
            indexContainerStyle={{right: 24}}
            indexLetterContainerStyle={{marginBottom: 3,}}
            /> */}
            <FlatList
